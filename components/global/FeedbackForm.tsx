...
import { User, Mail, Phone, Send, CheckCircle2, MessageSquare, HelpCircle } from "lucide-react";
...
export default function FeedbackForm() {
    const [formData, setFormData] = useState<FeedbackFormData>(INITIAL_FORM_STATE);
    ...
    const validateForm = (): boolean => {
        ...
        if (formData.phone.trim() && !/^\+?[0-9\s\-()]{8,16}$/.test(formData.phone.trim())) {
            newErrors.phone = "Please enter a valid phone number";
        }

        if (!formData.feedbackType) newErrors.feedbackType = "Please select a feedback type";
        if (!formData.message.trim()) newErrors.message = "Feedback details are required";
            ...
            {!isSubmitted ? (
                ...
                >
                    ...
                    <p className="text-slate-500 text-sm mb-6">
                        We value your input. Please fill out the form below to help us improve our services.
                    </p>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6" noValidate>
                        ...
                        <div className="pt-6 border-t border-slate-200 flex flex-col sm:flex-row items-center justify-between gap-4">
                            <p className="text-xs text-slate-500">
                                You can choose to remain anonymous by leaving the contact fields blank.
                            </p>
                ...
                >
                    ...
                    <p className="text-slate-600 leading-relaxed mb-8">
                        Thank you for sharing your thoughts with us. Your feedback helps us continuously improve the quality of our care.
                    </p>
