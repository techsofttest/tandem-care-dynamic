...
function ReferralsPageContent() {
  ...
  const serviceOptions = [
    ...
    "Employment Support",
    "Short Term Respite",
    "Home and Community Support in Supported Accommodation",
    "Supported Independent Living (SIL)",
    "SIL + Specialist Disability Accommodation (SDA)",
  ...
  return (
    <div className="flex flex-col min-h-screen bg-slate-50/50">
      ...
      <PageBanner
        ...
        subtitle="Complete this form if you would like to use The Star Care Group’s services."
        breadcrumbs={[{ name: "Referrals" }]}
      />
                        ...
                        <div>
                          ...
                          <div className="mt-2 flex flex-col sm:flex-row sm:gap-6">
                            ...
                            <span>
                              <strong>Email:</strong>{" "}
                              <a
                                href="mailto:info@thestarcaregroup.com.au"
                                className="text-brand-blue font-semibold hover:underline"
                              >
                                info@thestarcaregroup.com.au
                              </a>
                            </span>
                          </div>
                        </div>
                      ...
                      <div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          {serviceOptions.map((opt) => {
                            const isChecked =
                              formData.servicesNeeded.includes(opt);
                            return (
                              <button
                                key={opt}
                                type="button"
                                onClick={() =>
                                  handleCheckboxToggle("servicesNeeded", opt)
                                }
                              ...
                              >
                                ...
                                <span
                                  className={`font-bold text-xs sm:text-sm ${isChecked ? "text-brand-blue" : "text-slate-800"}`}
                                >
                                  {opt}
                                </span>
                              </button>
