...
export default function FeedbackPage() {
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-[#3592CF]/5 via-slate-50/50 to-[#FCB040]/5 relative overflow-hidden">
      ...
      <PageBanner
        title="Your Feedback"
        subtitle="Help us refine and improve our services by sharing your thoughts."
        breadcrumbs={[{ name: "Feedback" }]}
      />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
            ...
            <div className="lg:col-span-5 space-y-6 lg:sticky lg:top-24">
              ...
              <div className="space-y-6">
                {/* Feature 1: Safe and Confidential */}
